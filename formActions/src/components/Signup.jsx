      ...
      <fieldset>
        ...
        <div className="control">
          <input
            ...
            name="acquisition"
            value="google"
            defaultChecked={formState.values?.acquisitions?.includes("google")}
          />
        ...
        <div className="control">
          <input
            ...
            name="acquisition"
            value="friend"
            defaultChecked={formState.values?.acquisitions?.includes("friend")}
          />
        ...
        <div className="control">
          <input
            ...
            name="acquisition"
            value="other"
            defaultChecked={formState.values?.acquisitions?.includes("other")}
          />
